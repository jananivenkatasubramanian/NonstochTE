...
params=[];
n=0;
Ns=20; % set number of samples based on required confidence
...
Z_1s=(dds)*ones(1,L)*(Utilde')*(Vx0');
Z_2s=kron((Vphi0*Utilde),eye(nx));
Zs=[Z_1s;Z_2s];
